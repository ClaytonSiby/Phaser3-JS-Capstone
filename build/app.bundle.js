...
var _PlayerScene = __webpack_require__(1);

var _PlayerScene2 = _interopRequireDefault(_PlayerScene);

var _MenuScene = __webpack_require__(34);

var _MenuScene2 = _interopRequireDefault(_MenuScene);

var _Level1Scene = __webpack_require__(35);

var _Level1Scene2 = _interopRequireDefault(_Level1Scene);

var _Level2Scene = __webpack_require__(36);

var _Level2Scene2 = _interopRequireDefault(_Level2Scene);

var _Level3Scene = __webpack_require__(37);

var _Level3Scene2 = _interopRequireDefault(_Level3Scene);

var _GameOverScene = __webpack_require__(38);

var _GameOverScene2 = _interopRequireDefault(_GameOverScene);

var _LeaderBoardScene = __webpack_require__(39);
...
var Level1Scene = function (_PlayerScene) {
  _inherits(Level1Scene, _PlayerScene);

  function Level1Scene() {
    _classCallCheck(this, Level1Scene);

    return _possibleConstructorReturn(this, (Level1Scene.__proto__ || Object.getPrototypeOf(Level1Scene)).call(this, 'Level1Scene'));
  }
  ...
  _createClass(Level1Scene, [{
    ...
    value: function create() {
      ...
      var bgCoordinates = [{ x: 100, y: 100 }, { x: 500, y: 150 }, { x: 800, y: 100 }, { x: 300, y: 300 }, { x: 100, y: 500 }, { x: 900, y: 300 }, { x: 600, y: 400 }];

      var platformPositions = [{ x: 158, y: 580 }, { x: 350, y: 580 }, { x: 500, y: 580 }, { x: 800, y: 580 }, { x: 1000, y: 580 }];
      ...
      this.physics.add.collider(bugs, platforms, function (bug) {
        ...
        _this2.score += 10;
        _this2.scoreText.setText('Score: ' + _this2.score);
      });

      // collide a bug & the character then its game over
      this.physics.add.collider(this.gameState.character, bugs, function () {
        _this2.bugGeneratorLoop.destroy();
        _this2.gameOnSound.stop();
        _this2.gameOverSound.play();
        _this2.physics.pause();
        _this2.registry.set('playerScore', _this2.score);
        _this2.scene.start('GameOverScene');
      });
    }
  }, {
    key: 'update',
...
var Level2Scene = function (_PlayerScene) {
  _inherits(Level2Scene, _PlayerScene);

  function Level2Scene() {
    _classCallCheck(this, Level2Scene);

    return _possibleConstructorReturn(this, (Level2Scene.__proto__ || Object.getPrototypeOf(Level2Scene)).call(this, 'Level2Scene'));
  }
  ...
  _createClass(Level2Scene, [{
    ...
    value: function create() {
      ...
      var bugs = this.physics.add.group();
      var thebugs = ['green_bug', 'yellow_bug'];

      function bugGenerator() {
        var xCoordinate = Math.random() * 1000;
        var randomBug = thebugs[Math.floor(Math.random() * 2)];
...
var Level3Scene = function (_PlayerScene) {
  _inherits(Level3Scene, _PlayerScene);

  function Level3Scene() {
    _classCallCheck(this, Level3Scene);

    return _possibleConstructorReturn(this, (Level3Scene.__proto__ || Object.getPrototypeOf(Level3Scene)).call(this, 'Level3Scene'));
  }
  ...
  _createClass(Level3Scene, [{
    ...
    value: function create() {
      ...
      var bugs = this.physics.add.group();
      var theBugList = ['green_bug', 'yellow_bug', 'red_bug'];

      function bugGenerator() {
        var xCoordinate = Math.random() * 1000;
        var randomBug = theBugList[Math.floor(Math.random() * 3)];
